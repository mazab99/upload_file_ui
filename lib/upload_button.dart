  ...
  void initState() {
    ...
    _uploadButtonScale = Tween<double>(begin: 0.8, end: 1.0).animate(
      CurvedAnimation(
        ...
        curve: const Interval(0.0, 0.05, curve: Curves.easeInCubic),
      ),
    );
              ...
              children: [
                      ...
                      child: Container(
                        ...
                        width: Tween<double>(begin: 100, end: deviceWidth)
                            .animate(CurvedAnimation(
                                parent: _animationController,
                                curve: const Interval(0.08, 0.2,
                                    curve: Curves.easeInQuad)))
                            .value,
                        decoration: BoxDecoration(
                          color: const Color(0xFFF79C70),
                ...
                SlideTransition(
                  position: Tween<Offset>(
                    ...
                    CurvedAnimation(
                      parent: _animationController,
                      curve: const Interval(0.08, 0.14),
                    ),
                  ),
                ...
                Visibility(
                  ...
                  child: SlideTransition(
                    position: Tween<Offset>(
                            begin: Offset.zero, end: const Offset(0, 1.0))
                        .animate(
                      CurvedAnimation(
                        parent: _animationController,
                        curve:
                            const Interval(0.7, 0.8, curve: Curves.easeInQuart),
                      ),
                    ),
                    child: Container(
                      width: deviceWidth,
